                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                   value="{{ old('last_name') ?? $user->last_name }}" name="last_name" id="exampleInputLastName" placeholder="Enter Last Name">
                            @error('last_name')
                            <br>
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                   value="{{ old('email') ?? $user->email }}" name="email" id="exampleInputEmail" placeholder="Enter Email">
                            @error('email')
                            <br>
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                   value="{{ old('password') ?? $user->password }}" name="password" id="exampleInputPassword" placeholder="Enter Password">
                            @error('password')
                            <br>
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            <select name="shop_id" id="exampleInputShop" class="form-control @error('shop_id') is-invalid @enderror">
                                <option>Please select Shop</option>
                                @foreach($shops as $shop)
                                    <option @if((old('shop_id') && old('shop_id') == $shop->id) || $shop->id == $user->shop_id) selected @endif value="{{ $shop->id }}">{{ $shop->name }}</option>
                                @endforeach
                            </select>
                            @error('shop_id')
                            <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-4">
                                <img src="{{ Illuminate\Support\Facades\Storage::url('user_img/thumbnail/'.$user->img) }}" class="user-image" alt="User Image">
                            </div>
